...
En los siguientes puntos, se explicarán los datos con los que se va a trabajar, se realizará el análisis de requerimientos y limitaciones de la 
aplicación a desarrollar y se detallará el desarrollo de la misma.
