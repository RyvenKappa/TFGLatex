...
\textit{\acrfullr{mts}}, grabados a 25 \acrshort{fps} y con un bitrate (tasa de datos por segundo) de \texttt{16.96 Mbps}.
...
Se tiene en cuenta que para los videos siempre se sigue el orden \textit{\acrfullr{ltr}}, por lo tanto, para el video \verb|23_NT_R2_J2_P1_2|, el pez de la izquierda será el pez número 1 y 
...
Respecto a datos técnicos del video, el contenedor ha cambiado a \textit{\acrfullr{mov}}, se mantienen los 25 \acrshort{fps} y el bitrate aumenta hasta los \texttt{21 Mbps}.
