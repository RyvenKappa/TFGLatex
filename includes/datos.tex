...
\begin{figure}[h]
    ...
    \caption{Aspecto de los videos con truchas jóvenes}
...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{Estructura de los  videos de truchas adultas}
...
\begin{figure}[H]
    ...
    \caption{Aspecto de los videos de truchas adultas}
...
Los videos obtenidos en este caso también contienen videos de experimentos en grupo, es decir, varios experimentos a varias parejas de truchas. Sin embargo, a diferencia de los videos de truchas jóvenes, 
...
Por motivos ajenos a este trabajo, no se cuentan con las etiquetas manuales correspondientes a los videos de truchas jóvenes. Esto implica que no se tiene un marco de referencia para 
contar los movimientos de los videos más antiguos.

\subsubsection*{Videos de truchas adultas}
...
\begin{figure}[H]
    ...
    \caption{Sección del archivo de movimientos finales para los videos de truchas adultas}
    \label{fig:Excel2}
\end{figure}
