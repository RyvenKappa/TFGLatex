...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\textwidth]{images/4/TransferLearning.png}
    ...
    caracterización de imagen, existen muchas facilidades en entornos matemáticos como MATLAB o de procesado de datos como el lenguaje de programación Python, más concretamente la librería de \textit{OpenCV}.
    
    \item \textbf{Abstracción de la red neuronal al \texttt{HardWare}}
\end{itemize}
