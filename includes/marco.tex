...
\begin{itemize}
    ...
    Este sistema se va repitiendo para cada capa de convolución, hasta que en la última capa de \texttt{polling}, la salida es un vector horizontal cuya profundidad es la misma que neuronas de entrada tenga la etapa de clasificación. 
