...
\fancypagestyle{specialpage}{%
  \fancyhf{}
  \fancyhead[OL]{\textit{1  LISTA DE ACRÓNIMOS}}
  \fancyhead[ER]{\textit{1  LISTA DE ACRÓNIMOS}}
  \fancyfoot[EL]{\thepage}
  \fancyfoot[OR]{\thepage}
}
\fancypagestyle{indicefig}{
  \fancyhf{}
  \fancyhead[OL]{\textit{ÍNDICE DE FIGURAS Y TABLAS}}
  \fancyhead[ER]{\textit{ÍNDICE DE FIGURAS Y TABLAS}}
  \fancyfoot[EL]{\thepage}
  \fancyfoot[OR]{\thepage}
}
